...
from app.routers import praktis_assets as r_assets
...
def startup():
    ...
    # 4) START EMAIL SCHEDULER LOOP (new)
    asyncio.get_event_loop().create_task(r_email.email_scheduler_loop())
